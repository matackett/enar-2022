...
Make a scatterplot the relationship between percent of time using an electronic device for school (`device_school`) and for leisure activities (`device_leisure`) by `region`.  and school format. Make a scatterplot using color and faceting to visualize the relationship between these variables. 
...
responses <- responses %>%
  mutate(instagram  = str_detect(social_media, "___"))
```
